...
def build_review_prompt(office):
    ...
    return (
        ...
        f"Use broad theme labels only. For PositiveThemes choose at most 2 items from this list: "
        f"['Location & Access', 'Workspace Quality', 'Atmosphere & Design', 'Facilities & Amenities', 'Team & Service']. "
        f"For NegativeThemes choose at most 2 items from this list: "
        f"['Management & Service', 'Maintenance & Upkeep', 'Access & Convenience', 'Workspace Quality']. "
        f"If there is no clearly supported negative theme, return an empty NegativeThemes array instead of a placeholder. "
